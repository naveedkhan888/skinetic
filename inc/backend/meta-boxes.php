 ...
 */
function skinetic_register_meta_boxes( $meta_boxes ) {
	
	// Post format's meta box
	$meta_boxes[] = array(
		'id'       => 'format_detail',
		'title'    => esc_html__( 'Format Details', 'skinetic' ),
		'pages'    => array( 'post' ),
		'context'  => 'normal',
		'priority' => 'high',
		'autosave' => true,
		'fields'   => array(
			array(
				'name'             => esc_html__( 'Image', 'skinetic' ),
				'id'               => 'post_image',
				'type'             => 'image_advanced',
				'class'            => 'image',
				'max_file_uploads' => 1,
			...
			array(
				'name'  => esc_html__( 'Gallery', 'skinetic' ),
				'id'    => 'post_gallery',
				'type'  => 'image_advanced',
				'class' => 'gallery',
				// Image size that displays in the edit page. Possible sizes small,medium,large,original
			...
			array(
				'name'  => esc_html__( 'Audio', 'skinetic' ),
				'id'    => 'post_audio',
				'type'  => 'textarea',
				'cols'  => 20,
				'rows'  => 2,
			...
			array(
				'name'  => esc_html__( 'Video', 'skinetic' ),
				'id'    => 'post_video',
				'type'  => 'textarea',
				'cols'  => 20,
				'rows'  => 2,
			...
			array(
				'name'  => esc_html__( 'Background Video', 'skinetic' ),
				'id'    => 'bg_video',
				'type'  => 'image_advanced',
				'class' => 'video',
				'max_file_uploads' => 1,
			...
			array(
				'name'  => esc_html__( 'Text Link', 'skinetic' ),
				'id'    => 'text_link',
				'type'  => 'textarea',
				'cols'  => 20,
				'rows'  => 2,
			...
			array(
				'name'  => esc_html__( 'Quote', 'skinetic' ),
				'id'    => 'post_quote',
				'type'  => 'textarea',
				'class' => 'quote',
			),
			array(
				'name'  => esc_html__( 'Quote Name', 'skinetic' ),
				'id'    => 'quote_name',
				'type'  => 'text',
				'class' => 'quote',
			)		
	...
	$meta_boxes[] = array(
		'id'       => 'page-settings',
		'title'    => esc_html__( 'Page Header Settings', 'skinetic' ),
		'pages'    => array( 'page' ),
		'context'  => 'normal',
		'priority' => 'high',
		'autosave' => true,
		'fields'   => array(
            array(
                'id'        => 'page_layout',
                'name'      => esc_html__( 'Page Layout', 'skinetic' ),
                'type'      => 'image_select',
                'options'   => array(
            ...
            array(
                'name'             => esc_html__( 'Page Header On/Off', 'skinetic' ),
                'id'               => 'pheader_switch',
                'type'             => 'switch',
                'style'            => 'rounded',
                'on_label'         => 'On',
            ...
            array(
                'name'             => esc_html__( 'Background Page Header', 'skinetic' ),
                'id'               => 'pheader_bg_image',
                'type'             => 'image_advanced',
                'max_file_uploads' => 1,
            )
	...
	$meta_boxes[] = array (
      	...
      	'fields' =>   array (  
			...
			array(
                'name'             => esc_html__( 'Header Transparent?', 'skinetic' ),
                'id'               => 'is_trans',
				'type'             => 'select',
				'options'   => array(
                    'default'   => 'Default',
	...
	$meta_boxes[] = array(
        'id'       => 'case-settings',
        'title'    => esc_html__( 'Project Settings', 'skinetic' ),
        'pages'    => array( 'xp_portfolio' ),
        'context'  => 'normal',
        'priority' => 'high',
        'autosave' => true,
        'fields'   => array(
            array(
                'name'             => esc_html__( 'Carousel Image', 'skinetic' ),
                'id'               => 'slide_img',
                'type'             => 'image_advanced',
                'max_file_uploads' => 1,
            ),
    ...
    $meta_boxes[] = array(
        'id'       => 'pthumb-settings',
        'title'    => esc_html__( 'Thumbnail Image Settings', 'skinetic' ),
        'pages'    => array( 'xp_portfolio' ),
        'context'  => 'normal',
        'priority' => 'high',
        'autosave' => true,
        'fields'   => array(
            array(
                'id'        => 'thumb_size',
                'name'      => esc_html__( 'Select Size', 'skinetic' ),
                'type'      => 'select',
                'options'   => array(
                    'normal' 	=> 'Normal Width',
...
add_filter( 'rwmb_meta_boxes', 'skinetic_register_meta_boxes' );